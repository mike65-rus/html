...
function(kendo, DocBase, mySelObject, proxy, sessionService, utils,ibDocsDs,allUsersDs,allOtdelsDs,allShefsDs){
    ...
    Doc12 = DocBase.extend({
		...
		openFormWindow: function(mode) {
            ...
            var title = "Форма осмотра. " + patient.fio;
                            ...
                            that.dsGetById.read({record_id:record_id}).then(function(){
                                ...
                                if (ds._data) {
                                    if (ds._data.length) {
                                        ...
                                        that.oldAskId=ds._data[0].ask_id;
...
//                console.log(data);
                   if (data.error == '') {
                       ...
                       pom.setAttribute('download', sFile + '_' + curIb.fio.replaceAll(' ', '_')+'_Дневник' + ".docx");
                       setTimeout(function () {
                           pom.click();
                       }, 2000);
