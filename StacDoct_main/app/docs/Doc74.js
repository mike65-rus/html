		...
		//      alertify.alert("Part Change");
			...
			*/
			...
			newSurvey: function() {
				...
				var sLink = location.origin+"/Medsystem/ExpertReview/Home/Kili?askid=" + this.askId + "&uid=" + Number(localStorage['last_user']) + "&isreview1=True";
			...
			editSurvey: function() {
                ...
                var sLink = location.origin+"/Medsystem/ExpertReview/Home/Kili?askid=" + this.askId + "&uid=" + Number(localStorage['last_user']) + "&isreview=True";
