...
define(["kendo.all.min","models/ibDocModel","utils","services/proxyService"],function(kendo,model,utils,proxy){
   'use strict';
    ...
    var dsCreate = new kendo.data.DataSource({
        ...
        transport: {
            read: {
                url: "default.aspx?action=StacDoct_main/ibDocs_AJAX&action2=create_doc",
                dataType: "json"
            }
        },
        requestEnd: utils._onRequestEnd,
    ...
    var dsDelete = new kendo.data.DataSource({
        ...
        transport: {
            read: {
                url: "default.aspx?action=StacDoct_main/ibDocs_AJAX&action2=delete_doc",
                dataType: "json"
            }
        },
        requestEnd: utils._onRequestEnd,
    ...
    var dsGetById= new kendo.data.DataSource({
        ...
        transport: {
            read: {
                url: "default.aspx?action=StacDoct_main/ibDocs_AJAX&action2=get_doc_by_id",
                dataType: "json"
            }
        },
        requestEnd: utils._onRequestEnd,
