define(['kendo.all.min','utils','kendo-template!views/patientCardDeseasesDisp',
        'services/proxyService','classes/generalTab',
        'dataSources/deseasesListDispDataSource','dataSources/periodDeseasesDispDataSource',
        'dataSources/deseasesDetailsDataSource',
        'viewModels/deseasesDispDetailsVm'
    ],
    function(kendo,utils,viewId,proxy,GeneralTab,visitsListDs,dsPeriod,dsDetails,detailsVm) {
        ...
        var gridSelector="#exams_deseases_disp_grid";
        ...
        var viewModel=new kendo.data.ObservableObject({
            ...
            onViewDetailsButtonClicked:function(e) {
                ...
                if (row && row.length) {
                    ...
                    proxy.publish("deseasesDispViewDetails",{parentModel:viewModel})
//                    console.log(detailsDs.data());
        ...
        var bindWidgets=function() {
            ...
            kendo.bind("#exams-deseases-disp-toolbar",viewModel);
            var grid=$(gridSelector).data("kendoGrid");
        ...
        var doQuery=function(iPatientId,dDateEnd){
            ...
            $(gridSelector).hide();
            kendo.ui.progress($("#deseases-tab-disp"),true);
            ...
            then(function() {
                kendo.ui.progress($("#deseases-tab-disp"),false);
                $(gridSelector).show();
                var grid=$(gridSelector).data("kendoGrid");
                if (grid) {
                    grid.resize();
