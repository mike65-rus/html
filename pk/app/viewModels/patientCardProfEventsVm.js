/* Профилактические мероприятия - main window */
define(['kendo.all.min','utils','services/proxyService',
        'classes/generalTab',
        'kendo-template!views/patientCardProfEvents',
        'viewModels/patientCardProfEventsMonitorTfomsVm',
        'viewModels/patientCardProfEventsMonitorTfomsAllVm',
        'viewModels/patientCardDuEventsMonitorTfomsVm'
    ...
    function (kendo,utils,proxy,GeneralTab,viewId,listVm) {
        ...
        var options={
            ...
            tabStripSelector:"#patient-card-prof-events-tabstrip",
            viewModel:viewModel,
...
//            suffix:myTab.tabStripsNames[0]
        ...
        var bindWidgets=function() {
            kendo.bind($(options.tabStripSelector),viewModel);
        };
